        ...
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <article class="card card-post">
              <img
                :src="require('../assets/img/posts/1.jpg')"
                class="card-img-top"
              />
              <div class="card-body">
          ...
          <div class="col-md-3 col-sm-6">
            <article class="card card-post">
              <img
                :src="require('../assets/img/posts/2.jpg')"
                class="card-img-top"
              />
              <div class="card-body">
          ...
          <div class="col-md-3 col-sm-6">
            <article class="card card-post">
              <img
                :src="require('../assets/img/posts/3.jpg')"
                class="card-img-top"
              />
              <div class="card-body">
          ...
          <div class="col-md-3 col-sm-6">
            <article class="card card-post">
              <img
                :src="require('../assets/img/posts/4.jpg')"
                class="card-img-top"
              />
              <div class="card-body">
