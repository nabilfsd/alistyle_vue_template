<template>
  <div id="category-section-requistion">
      ...
      <div class="row">
        <div class="col-md-8">
          <div
            ...
            :style="{'backgroundImage':'url(' + require('../../assets/img/banners/banner9.jpg') + ')'}">
...
<script>
export default {
  name: 'CategorySectionRequistion',
  data () {
    return {
      image: {
        backgroundImage: 'url(../../assets/img/banners/banner9.jpg)'
      }
    }
  }
}
